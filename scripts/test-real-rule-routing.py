...
CASES = [
    ...
    ('google.com', 'Google', '机场名称3优先'),
    ('services.googleapis.cn', 'Google', '机场名称3优先'),
    ('redirector.xn--ngstr-lra8j.com', 'Google', '机场名称3优先'),
    ('www.googleapis.cn', 'Google', '机场名称3优先'),
    ('fonts.gstatic.cn', 'Google', '机场名称3优先'),
    ('www.google.ms', 'Google', '机场名称3优先'),
    ('www.ggpht.cn', '境外影音', '机场名称3优先'),
    ('cloud.cupronickel.goog', 'Google', '机场名称3优先'),
    ('youtube.com', '境外影音', '机场名称3优先'),
    ('mtalk.google.com', 'Google', '机场名称3优先'),
    ('fcm.googleapis.com', 'Google', '机场名称3优先'),
...
DOWNLOAD_WITNESSES = {
    ...
    'release-assets.githubusercontent.com', 'codeload.github.com', 'aur.archlinux.org',
}
